...
- 忽视消费者市场才是未来主战场
- 过度强调安全性而忽视用户体验
- 将iOS/Android视为玩具而非威胁

最终，当企业市场也开始接受BYOD（Bring Your Own Device）理念时，BlackBerry已经失去了最后的堡垒。

### 1.2 组织僵化的内部信号

组织僵化是公司衰落的内在根源，往往比外部竞争更致命。Yahoo的衰落很大程度上源于内部的组织失能。

**Yahoo的组织病症剖析（2005-2016）：**

- **决策链条延长**：从想法到执行的时间显著增加
  - 2005年：产品决策平均需要2周
  - 2010年：扩展到6-8周
  - 2015年：部分项目审批超过3个月
  - 期间错失收购Facebook（2006）、拒绝微软收购（2008）等关键机会

- **创新项目失败率上升**：内部创新难以获得资源支持
  - Yahoo Mail改版延迟3年，被Gmail彻底超越
  - Yahoo Video错失YouTube收购，自建平台失败
  - 移动战略摇摆不定，先后尝试5种不同方向
...
- **部门墙加厚**：跨部门协作困难，内耗增加
  - 搜索、邮箱、新闻各自为战，用户数据无法打通
  - 产品团队与销售团队目标冲突，用户体验持续恶化
  - 技术债务累积，不同团队使用30+种技术栈

**微软的"失去的十年"（2000-2010）组织症状：**
```
组织健康度评分卡（满分10分）
                    2000年  2010年  变化
创新活力            8.5     4.0    -53%
...
核心问题：
- Stack Ranking制度导致内部竞争大于外部竞争
- Windows的成功导致"创新者困境"
- 各部门各自为战，Office拒绝支持移动平台
```
